...
if (carClass instanceof Car) {
    if (el.checked) {
        if (carArr.length >= 2) {
            alert("Você só pode comparar 2 carros de uma vez");
            el.checked = false;
        } else {
...
function UpdateCompareTable() {
    document.getElementById("compare_image_0").innerHTML = "<img src='" + carArr[0].image + "'>";
    ...
    document.getElementById("compare_preco_0").innerText = carArr[0].preco;

    document.getElementById("compare_image_1").innerHTML = "<img src='" + carArr[1].image + "'>";
    ...
    document.getElementById("compare_preco_1").innerText = carArr[1].preco;
